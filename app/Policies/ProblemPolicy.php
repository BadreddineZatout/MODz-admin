...
class ProblemPolicy
{
    ...
    {
        return $user->can('view_any_problem');
    }
    ...
    {
        return $user->can('create_problem');
    }
    ...
    {
        return $user->can('update_problem');
    }
    ...
    {
        return $user->can('delete_problem');
    }
    ...
    {
        return $user->can('delete_any_problem');
    }
     ...
     */
    public function replicate(User $user, Problem $problem): bool
    {
